...
local function check_setup(claudecode)
  ...
  error_("setup() has not been called", { 'Call require("codriver.vendor.claudecode").setup() (or use your plugin manager\'s opts)' })
  return false
end
...
function M.check()
  ...
  local loaded, claudecode = pcall(require, "codriver.vendor.claudecode")
  if not loaded then
